...
{
    public partial class AccionProveedor : Form
    {
        public AccionProveedor(string accion)
        {
            InitializeComponent();
        ...
        public AccionProveedor(string accion, string id, string nombre, string p_a, string s_a, string curp, string rfc, string direccion, string email, string telefono/*, bool estado*/)
        {
            InitializeComponent();
            lblAccion.Text = accion;
            txtID.Text = id;
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    respuesta = ControllerPersona.Actualizar(Convert.ToInt32(txtID.Text), "Proveedor", txtNombre.Text, txtPrimerApellido.Text, txtSegundoApellido.Text,
                ...
                {
                    respuesta = ControllerPersona.Insertar("Proveedor", txtNombre.Text, txtPrimerApellido.Text, txtSegundoApellido.Text,
